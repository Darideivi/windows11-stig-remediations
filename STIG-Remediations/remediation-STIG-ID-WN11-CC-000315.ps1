<#
.SYNOPSIS
    Disables the Windows Installer "Always install with elevated privileges"
    setting, which would otherwise let any user install MSI packages with
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\remediation-STIG-ID-WN11-CC-000315.ps1
